...
from algorithms.a_star_visual import Step, StepType, VisualAStarSolver
...
class AkariUI:
    ...
    def __init__(self, initial_puzzle: Optional[str] = None) -> None:
        ...
        self._algo_names = ["A* + Propagation"]
        self._algo_idx = 0
    ...
    def _start_solver(self) -> None:
        ...
        solver = VisualAStarSolver(self.board, self._step_queue,
    ...
    def _apply_step(self, step: Step) -> None:
        ...
        self._frontier_size = step.frontier_size
        self._f_n = step.f_n
    ...
    def _draw_info_panel(self) -> None:
        ...
        stats = [
            ...
            ("Frontier size", f"{self._frontier_size:,}"),
            ("f(n)", f"{self._f_n:.0f}"),
